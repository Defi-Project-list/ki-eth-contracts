...
backupableTests(async (factoryOwner1, factoryOwner2, factoryOwner3, walletOwner) => {
    const sw_factory = await Factory.new(factoryOwner1, factoryOwner2, factoryOwner3, { from: factoryOwner1 });
    const sw_factory_proxy = await FactoryProxy.new(factoryOwner1, factoryOwner2, factoryOwner3, ZERO_ADDRESS, { from: factoryOwner1 });
